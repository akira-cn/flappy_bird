APPNAME="FlappyBird"
DEBUG=false
NDK_ROOT="$HOME/Workspace/tools/android-ndk-r9b"
...
cp -rf "$APP_ROOT"/lib/cqwrap/js/cqwrap "$APP_ANDROID_ROOT"/assets

# compile js
if [ $DEBUG = false ]; then
COCOS2D_CONSOLE=$COCOS2DX_ROOT/tools/cocos2d-console/console
python $COCOS2D_CONSOLE/cocos2d.py jscompile -s assets/  -d assets/;
cd assets;
